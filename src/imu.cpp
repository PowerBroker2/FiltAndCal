...
// double imuCal::magRotMinFunc(const VectorXd& vec)
// {
//     // Convert rotation vector to DCM
//     Matrix3d dcm = rotVec_2_dcm(vec);

//     // Calc guess values
//     Matrix3d guess = dcm * magDataMat;
...
// double imuCal::magScalesMinFunc(const VectorXd& scales)
// {
//     return 4.1;
// }
...
//     accelTruthVec = accelTruthVec.normalized() * accelTruthMag;
// }
...
//     magTruthVec = magTruthVec.normalized() * magTruthMag;
// }
...
// {
//     if (norm)
//         return (mag_A_inv * (point - mag_b)).normalized();
//     return mag_A_inv * (point - mag_b);
// }